...
insert  into `account`(`id`,`username`,`sha_pass_hash`,`sessionkey`,`v`,`s`,`token_key`,`email`,`reg_mail`,`joindate`,`last_ip`,`last_attempt_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`expansion`,`mutetime`,`mutereason`,`muteby`,`locale`,`os`,`recruiter`,`recruiter_rewarded`,`battlenet_account`,`battlenet_index`) values 
(5,'4#1','158E71C601400EFD35E6DA64EDB68421FC79983A','E6C38459C7C3D0250F1DDCBF10D4C3DDD10103DF2AF7C419BF8E83DACE0987F2DAB8AF4A5C489C9E','','','','ZGN88@MAIL.RU','ZGN88@MAIL.RU','2019-05-12 19:48:29','127.0.0.1','127.0.0.1',0,0,'00','2019-05-12 19:56:09',0,7,0,'','',8,'Wn64',0,0,4,1),
(6,'5#1','C6FFEDE5A5FA967052A643BA698B7CB4FF8E5C98','592F7DA57A637DE5D554832234B74C97B4DB460C54EB47EECD7B50D95828084A3FB63C978541BC8B','','','','ANDER@ANDER','ANDER@ANDER','2019-06-17 18:48:37','127.0.0.1','127.0.0.1',0,0,'00','2019-06-17 18:49:43',0,7,0,'','',8,'Wn64',0,0,5,1);
...
(5,1,1,1,'Testwar',1,1557680902),
(6,1,1,1,'Dersa',3,1560787332);
...
CREATE TABLE `battlenet_accounts` (
  ...
  `Avatar` text,
  `RecoveryId` tinytext,
  `CanEditWeb` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `CanEditScripts` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `IsWebAdmin` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Account System';

/*Data for the table `battlenet_accounts` */

insert  into `battlenet_accounts`(`id`,`email`,`sha_pass_hash`,`joindate`,`last_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`locale`,`os`,`LastCharacterUndelete`,`LoginTicket`,`LoginTicketExpiry`,`WebName`,`Avatar`,`RecoveryId`,`CanEditWeb`,`CanEditScripts`,`IsWebAdmin`) values 
(4,'ZGN88@MAIL.RU','1636DA39DF379CAD6C89B8C497BDFD6EE1FBD021CFA4EF957B015B459A029E7F','2019-05-12 19:48:29','127.0.0.1',0,0,'00','2019-05-12 19:56:07',0,8,'Wn64',0,'TC-235CD26FEC07A32DF7B4A457A965DB818D3FF4BF',1557683767,NULL,NULL,NULL,0,0,0),
(5,'ANDER@ANDER','7152EB4A3A5F88AF973884E27A34A282B24D1D9A02EBF9D15FAC2EBE99B3779E','2019-06-17 18:48:37','127.0.0.1',0,0,'00','2019-06-17 18:49:39',0,8,'Wn64',0,'TC-49419C6FD799D28095B148C721F581BB1D2888DD',1560790179,NULL,NULL,NULL,0,0,0);
...
CREATE TABLE `battlenet_item_appearances` (
  ...
  CONSTRAINT `battlenet_item_appearances_ibfk_1` FOREIGN KEY (`battlenetAccountId`) REFERENCES `battlenet_accounts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `battlenet_item_favorite_appearances` (
  ...
  CONSTRAINT `battlenet_item_favorite_appearances_ibfk_1` FOREIGN KEY (`battlenetAccountId`) REFERENCES `battlenet_accounts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('2019_02_20_00_auth.sql','B21B2CA9F6965636FEACA96F45B97FA99B99FA4B','ARCHIVED','2019-05-09 08:31:35',467),
('2019_04_13_00_auth.sql','900C58BDB79B2D2F22D07A46FE77A049C5B080FF','ARCHIVED','2019-05-09 08:31:35',341);
...
(1,1550269510,3601,1,'TrinityCore rev. cc74e99d5c06+ 2019-02-15 22:00:12 +0100 (master branch) (Win64, Release, Static)'),
(1,1550273346,1800,1,'TrinityCore rev. cc74e99d5c06+ 2019-02-15 22:00:12 +0100 (master branch) (Win64, Release, Static)'),
(1,1550308581,0,0,'TrinityCore rev. 5e5da7bc846a 2019-02-16 11:34:28 +0300 (merge branch) (Win64, Release, Static)'),
(1,1550313366,0,0,'TrinityCore rev. 5e5da7bc846a 2019-02-16 11:34:28 +0300 (merge branch) (Win64, Release, Static)'),
(1,1550325285,601,1,'TrinityCore rev. f52637eb2e52+ 2019-02-16 13:34:12 +0300 (master branch) (Win64, Release, Static)'),
(1,1550338666,0,0,'TrinityCore rev. f52637eb2e52+ 2019-02-16 13:34:12 +0300 (master branch) (Win64, Release, Static)'),
(1,1550353807,0,0,'TrinityCore rev. 24ebda027ba7+ 2019-02-17 00:38:49 +0300 (master branch) (Win64, Release, Static)'),
(1,1550360395,0,0,'TrinityCore rev. 24a35bf0b917 2019-02-17 01:54:57 +0300 (master branch) (Win64, Release, Static)'),
(1,1550363034,0,0,'TrinityCore rev. 24a35bf0b917 2019-02-17 01:54:57 +0300 (master branch) (Win64, Release, Static)'),
(1,1550367803,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550369800,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550370596,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550395669,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550409540,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550411218,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550411863,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550413206,0,0,'TrinityCore rev. 6777f7ca346d+ 2019-02-17 03:14:30 +0300 (master branch) (Win64, Release, Static)'),
(1,1550416476,0,0,'TrinityCore rev. e590b8b53636+ 2019-02-17 17:29:42 +0300 (master branch) (Win64, Release, Static)'),
(1,1550417232,601,1,'TrinityCore rev. e590b8b53636+ 2019-02-17 17:29:42 +0300 (master branch) (Win64, Release, Static)'),
(1,1550418137,0,0,'TrinityCore rev. e590b8b53636+ 2019-02-17 17:29:42 +0300 (master branch) (Win64, Release, Static)'),
(1,1550426447,601,1,'TrinityCore rev. eb61ce9f5c02+ 2019-02-17 18:52:26 +0300 (master branch) (Win64, Release, Static)'),
(1,1550427349,1200,1,'TrinityCore rev. eb61ce9f5c02+ 2019-02-17 18:52:26 +0300 (master branch) (Win64, Release, Static)'),
(1,1550437417,1200,1,'TrinityCore rev. eb61ce9f5c02+ 2019-02-17 18:52:26 +0300 (master branch) (Win64, Release, Static)'),
(1,1550441603,0,0,'TrinityCore rev. eb61ce9f5c02+ 2019-02-17 18:52:26 +0300 (master branch) (Win64, Release, Static)'),
(1,1550442137,0,0,'TrinityCore rev. eb61ce9f5c02+ 2019-02-17 18:52:26 +0300 (master branch) (Win64, Release, Static)'),
(1,1550442943,0,0,'TrinityCore rev. eb61ce9f5c02+ 2019-02-17 18:52:26 +0300 (master branch) (Win64, Release, Static)'),
(1,1550445255,0,0,'TrinityCore rev. 3464096b4555+ 2019-02-18 01:46:10 +0300 (master branch) (Win64, Release, Static)'),
(1,1550525853,0,0,'TrinityCore rev. 3464096b4555+ 2019-02-18 01:46:10 +0300 (master branch) (Win64, Release, Static)'),
(1,1550527641,0,0,'TrinityCore rev. 3464096b4555+ 2019-02-18 01:46:10 +0300 (master branch) (Win64, Release, Static)'),
(1,1550528484,0,0,'TrinityCore rev. 3464096b4555+ 2019-02-18 01:46:10 +0300 (master branch) (Win64, Release, Static)'),
(1,1550533300,600,1,'TrinityCore rev. 3464096b4555+ 2019-02-18 01:46:10 +0300 (master branch) (Win64, Release, Static)'),
(1,1550535868,0,0,'TrinityCore rev. e346f64d3e2d+ 2019-02-19 02:28:28 +0300 (master branch) (Win64, Release, Static)'),
(1,1550536363,0,0,'TrinityCore rev. e346f64d3e2d+ 2019-02-19 02:28:28 +0300 (master branch) (Win64, Release, Static)'),
(1,1550541488,0,0,'TrinityCore rev. e346f64d3e2d+ 2019-02-19 02:28:28 +0300 (master branch) (Win64, Release, Static)'),
(1,1550563433,0,0,'TrinityCore rev. 293b07114832+ 2019-02-19 05:03:37 +0300 (master branch) (Win64, Release, Static)'),
(1,1550564385,0,0,'TrinityCore rev. 293b07114832+ 2019-02-19 05:03:37 +0300 (master branch) (Win64, Release, Static)'),
(1,1557381127,0,0,'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, Release, Static)'),
(1,1557653288,9630,0,'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, Release, Static)'),
(1,1557679653,1223,1,'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, Release, Static)'),
(1,1560785807,1209,1,'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, Release, Static)');
