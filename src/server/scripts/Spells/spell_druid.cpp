...
enum DruidSpells
{
    ...
    SPELL_DRUID_ABUNDANCE_TALLENT                   = 207383,
...
public:
    ...
    class spell_dru_moonfire_SpellScript : public SpellScript
    {
        ...
        void HandleOnHit(SpellEffIndex /*effIndex*/)
        {
            ...
            if (caster->HasAura(SPELL_DRUID_TWIN_MOONS_TALENT))
            {
                caster->CastSpell(target, SPELL_DRUID_TWIN_MOONS, true);
...
public:
    ...
    class spell_dru_galactic_guardian_AuraScript : public AuraScript
    {
        ...
        void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            if (!target)
                return;
                if (caster->HasAura(SPELL_DRUID_BEAR_FORM) || caster->HasAura(SPELL_DRUID_CAT_FORM) || caster->HasAura(SPELL_DRUID_TRAVEL_FORM))
                    caster->CastSpell(target, SPELL_DRUID_MOONFIRE_CAT, true);
                else
...
public:
    ...
    class spell_dru_rejuvenation_SpellScript : public SpellScript
    {
        ...
        void HandleAfterHit()
        {
            ...
            if (caster->HasAura(SPELL_DRUID_ABUNDANCE_TALLENT))
